...
defaults('ADMIN_PASSWORD','KhnEwg&g{p!12');  	// Admin Password - CHANGE THIS TO ENABLE!!!
...
global $MY_SELF, $MY_SELF_WO_SORT, $time, $MYREQUEST, $col_black, $AUTHENTICATED; //due to CI the functions used below becomes nested funcs.
...
//var_dump("<pre>", $cache_mode, $cache); exit;
